    ...
    public class DAL_NhanVien : General
    {
        ...
        public static bool IsLogin(string UserName, string Password)
        {
            try
            {
                ...
                string Query = string.Format("select* from NHANVIEN where MaNhanVien = '{0}' and MatKhau = '{1}' and TrangThai = N'Tồn tại'", UserName, Password);
        ...
        public static DataTable Load()
        {
            ...
            {
                GetConnection();
                string Query = string.Format("select MaNhanVien, TenNhanVien, GioiTinh, NgaySinh, DiaChi, DienThoai, LOAINHANVIEN.TenLoai from NHANVIEN, LOAINHANVIEN where NHANVIEN.MaLoai = LOAINHANVIEN.MaLoai and NHANVIEN.TrangThai = N'Tồn tại' and LOAINHANVIEN.TrangThai = N'Tồn tại'");
                SqlCommand Command = new SqlCommand(Query, Connection);
        ...
        public static bool Delete(string Id)
        {
            ...
            {
                GetConnection();
                string Query = string.Format("update NHANVIEN set TrangThai = N'Huỷ' where MaNhanVien = '{0}'", Id);
                SqlCommand Command = new SqlCommand(Query, Connection);
                int Result = Command.ExecuteNonQuery();
                return (Result == 1);
            }
        ...
        public static DataTable SearchById(string Id)
        {
            ...
            {
                GetConnection();
                string Query = string.Format("select MaNhanVien, TenNhanVien, GioiTinh, NgaySinh, DiaChi, DienThoai, LOAINHANVIEN.TenLoai from NHANVIEN, LOAINHANVIEN where NHANVIEN.MaLoai = LOAINHANVIEN.MaLoai and NHANVIEN.TrangThai = N'Tồn tại' and LOAINHANVIEN.TrangThai = N'Tồn tại' and MaNhanVien = '{0}'", Id);
                SqlCommand Command = new SqlCommand(Query, Connection);
                DataTable Result = new DataTable();
                SqlDataReader DataReader = Command.ExecuteReader();
                if (DataReader.HasRows)
        ...
        public static DataTable SearchByName(string Name)
        {
            ...
            {
                GetConnection();
                string Query = string.Format("select MaNhanVien, TenNhanVien, GioiTinh, NgaySinh, DiaChi, DienThoai, LOAINHANVIEN.TenLoai from NHANVIEN, LOAINHANVIEN where NHANVIEN.MaLoai = LOAINHANVIEN.MaLoai and NHANVIEN.TrangThai = N'Tồn tại' and LOAINHANVIEN.TrangThai = N'Tồn tại' and TenNhanVien like N'%{0}%'", Name);
                SqlCommand Command = new SqlCommand(Query, Connection);
                DataTable Result = new DataTable();
                SqlDataReader DataReader = Command.ExecuteReader();
                if (DataReader.HasRows)
